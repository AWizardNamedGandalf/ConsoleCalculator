//Yes this is the microsoft tutorial
...
using namespace std;
// no std is not a disease in this case, its shorthand for standard
//I think we should not make fun of people with shorthands
